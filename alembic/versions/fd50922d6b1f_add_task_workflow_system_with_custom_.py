...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_organization_configs_id"), "organization_configs", ["id"], unique=False
    )
    op.create_table(
        "task_statuses",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_task_workflow_transitions_id"),
        "task_workflow_transitions",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_task_status_transitions_id"),
        "task_status_transitions",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "tasks", sa.Column("status", sa.VARCHAR(), autoincrement=False, nullable=False)
    )
    ...
    op.drop_index(
        op.f("ix_task_status_transitions_id"), table_name="task_status_transitions"
    )
    op.drop_table("task_status_transitions")
    op.drop_index(
        op.f("ix_task_workflow_transitions_id"), table_name="task_workflow_transitions"
    )
